...
class MathCaptcha:
    def __init__(self):
       ...
       #self.window.geometry('600x600')
        ...
        button = Button(self.frame2, text="I'M NOT A ROBOT" ,bg='#3498db',activebackground='tomato', command=self.check_auth)
    ...
    def check_captcha(self):
        ...
        if(self.answer==user_ans):
            ...
            self.frame2 = Frame(self.frame1, bg='#ffffff', padx=50, pady=20)
            self.frame2.pack()
            label1 = Label(self.frame2, text='!WARNING!', bg='#ffffff',fg='red', font='Times 30 bold')
            label1.grid(row=1,column=1,columnspan=2, pady=20)
            label2 = Label(self.frame2, text='Access denied, too many attempts.', bg='#ffffff', font='Times 15')
            label2.grid(row=2,column=1,columnspan=2, pady=20)
